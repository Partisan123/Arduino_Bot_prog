 ...
 * 
 *    Autobotix modular robot G-Bot0.7b
 */

ros::NodeHandle nh;

// pins for rotary Hall encoder inputs
#define LF_ENCODER_P 11   //Encoder pin 1
#define LF_ENCODER_N 10   //Encoder pin 2

#define LB_ENCODER_P 15 
#define LB_ENCODER_N 14

#define RF_ENCODER_P 21 
#define RF_ENCODER_N 20

#define RB_ENCODER_P 17 
#define RB_ENCODER_N 16

// pins for the motor outputs
#define motor_lf  28    //Motor PWM signal 
#define dir_lf1  2      //Direction pin 1
#define dir_lf2  3      //Direction pin 2
